import { m as createAstro, n as createComponent, o as renderTemplate, q as addAttribute, t as renderComponent, p as maybeRenderHead, u as renderSlot, s as spreadAttributes, v as renderHead } from './astro/server_Bs8d6JLF.mjs';
import 'kleur/colors';
/* empty css                         */
import { clsx } from 'clsx';
import { twMerge } from 'tailwind-merge';
import { S as SITE } from './consts_aI_Azcuc.mjs';
...
}, "/Users/josephmudd/repos/josephmudd.dev/node_modules/astro/components/ViewTransitions.astro", void 0);
...
}, "/Users/josephmudd/repos/josephmudd.dev/src/components/Container.astro", void 0);
...
}, "/Users/josephmudd/repos/josephmudd.dev/src/components/Link.astro", void 0);

const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header> ${renderComponent($$result, "Container", $$Container, {}, { "default": ($$result2) => renderTemplate` <div class="flex flex-wrap gap-y-2 justify-between"> ${renderComponent($$result2, "Link", $$Link, { "href": "/", "underline": false }, { "default": ($$result3) => renderTemplate` <div class="font-semibold"> ${SITE.NAME} </div> ` })} <nav class="flex gap-1"> ${renderComponent($$result2, "Link", $$Link, { "href": "/work" }, { "default": ($$result3) => renderTemplate` work ` })} <span> ${`/`} </span> ${renderComponent($$result2, "Link", $$Link, { "href": "/projects" }, { "default": ($$result3) => renderTemplate` projects ` })} </nav> </div> ` })} </header>`;
}, "/Users/josephmudd/repos/josephmudd.dev/src/components/Header.astro", void 0);
...
}, "/Users/josephmudd/repos/josephmudd.dev/src/components/BackToTop.astro", void 0);
...
const $$PageLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png"><link rel="manifest" href="/site.webmanifest"><link rel="mask-icon" href="/safari-pinned-tab.svg" color="#5bbad5"><meta name="msapplication-TileColor" content="#2b5797"><meta name="theme-color" content="#ffffff">${renderComponent($$result, "Head", $$Head, { "title": `${title} | ${SITE.NAME}`, "description": description })}${renderHead()}</head> <body> ${renderComponent($$result, "Header", $$Header, {})} <main> ${renderSlot($$result, $$slots["default"])} </main> ${renderComponent($$result, "Footer", $$Footer, {})} </body></html>`;
}, "/Users/josephmudd/repos/josephmudd.dev/src/layouts/PageLayout.astro", void 0);
